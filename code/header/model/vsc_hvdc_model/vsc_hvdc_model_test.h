#ifndef VSC_HVDC_MODEL_TEST_H
#define VSC_HVDC_MODEL_TEST_H
...
class VSC_HVDC_MODEL_TEST : public Test::Suite
{
    public:
        VSC_HVDC_MODEL_TEST();
    protected:
    ...
    protected:
        VSC_HVDC* get_test_hvdc();
        VSC_HVDC_MODEL* get_test_hvdc_model();
