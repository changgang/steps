#ifndef PE_ELECTRICAL_CONTROL_MODEL_H
#define PE_ELECTRICAL_CONTROL_MODEL_H

#include "header/model/model.h"
#include "header/block/integral_block.h"
class PE_ELECTRICAL_CONTROL_MODEL : public MODEL
{
    /*
    PE Electrical control model
    Inputs:
        PE source terminal AC voltage
        PE source terminal AC frequency
        PE source active power generation
        PE source reactive power generation
    Output:
        P and Q current command: IP, IQ
    */
    public:
        PE_ELECTRICAL_CONTROL_MODEL();
        virtual ~PE_ELECTRICAL_CONTROL_MODEL();
...
#endif // PE_ELECTRICAL_CONTROL_MODEL_H
