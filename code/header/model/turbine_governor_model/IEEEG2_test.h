...
#include "header/model/turbine_governor_model/IEEEG2.h"
#include "header/model/turbine_governor_model/turbine_governor_model_test.h"
using namespace std;

class IEEEG2_TEST : public TURBINE_GOVERNOR_MODEL_TEST
{
    public:
        IEEEG2_TEST();
    protected:
