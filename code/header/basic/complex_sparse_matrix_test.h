#ifndef COMPLEX_SPARSE_MATRIX_TEST_H
#define COMPLEX_SPARSE_MATRIX_TEST_H
...
class COMPLEX_SPARSE_MATRIX_TEST : public Test::Suite
{
    public:
        COMPLEX_SPARSE_MATRIX_TEST();
    protected:
        virtual void setup();
...
#endif // COMPLEX_SPARSE_MATRIX_TEST_H
