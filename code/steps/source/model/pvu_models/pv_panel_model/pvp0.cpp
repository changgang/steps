...
PVP0::PVP0(STEPS& toolkit) : PV_PANEL_MODEL(toolkit)
{
    clear();
}

PVP0::PVP0(const PVP0& model):PV_PANEL_MODEL(model.get_toolkit())
{
...
double PVP0::get_minimum_nonzero_time_constant_in_s()
{
