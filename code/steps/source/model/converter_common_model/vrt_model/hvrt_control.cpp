...
void HVRT_CONTROL::set_kP(double k)
{
    kP_during = k;
}
void HVRT_CONTROL::set_P_set_in_pu(double p)
{
    P_set_during = p;
}
void HVRT_CONTROL::set_k1_Ip(double k)
{
    k1_Ip_during = k;
}
void HVRT_CONTROL::set_k2_Ip(double k)
{
    k2_Ip_during = k;
}
void HVRT_CONTROL::set_Ip_set_in_pu(double I)
{
    Ip_set_during = I;
}
void HVRT_CONTROL::set_LVPL_low_voltage_in_pu(double v)
{
    lvpl_during.set_low_voltage_in_pu(v);
}
void HVRT_CONTROL::set_LVPL_high_voltage_in_pu(double v)
{
    lvpl_during.set_high_voltage_in_pu(v);
}
void HVRT_CONTROL::set_LVPL_gain_at_high_voltage(double g)
{
...
void HVRT_CONTROL::set_kQ(double k)
{
    kQ_during = k;
}
void HVRT_CONTROL::set_Q_set_in_pu(double q)
{
    Q_set_during = q;
}
void HVRT_CONTROL::set_k1_Iq(double k)
{
    k1_Iq_during = k;
}
void HVRT_CONTROL::set_k2_Iq(double k)
{
    k2_Iq_during = k;
}
void HVRT_CONTROL::set_Iq_set_in_pu(double I)
{
    Iq_set_during = I;
}
...
double HVRT_CONTROL::get_kP() const
{
    return kP_during;
}
double HVRT_CONTROL::get_P_set_in_pu() const
{
    return P_set_during;
}
double HVRT_CONTROL::get_k1_Ip() const
{
    return k1_Ip_during;
}
double HVRT_CONTROL::get_k2_Ip() const
{
    return k2_Ip_during;
}
double HVRT_CONTROL::get_Ip_set_in_pu() const
{
    return Ip_set_during;
}
double HVRT_CONTROL::get_LVPL_low_voltage_in_pu() const
{
    return lvpl_during.get_low_voltage_in_pu();
}
double HVRT_CONTROL::get_LVPL_high_voltage_in_pu() const
{
    return lvpl_during.get_high_voltage_in_pu();
}
double HVRT_CONTROL::get_LVPL_gain_at_high_voltage() const
{
...
double HVRT_CONTROL::get_kQ() const
{
    return kQ_during;
}

double HVRT_CONTROL::get_Q_set_in_pu() const
{
    return Q_set_during;
}

double HVRT_CONTROL::get_k1_Iq() const
{
    return k1_Iq_during;
}

double HVRT_CONTROL::get_k2_Iq() const
{
    return k2_Iq_during;
}

double HVRT_CONTROL::get_Iq_set_in_pu() const
{
...
void HVRT_CONTROL::check_when_vrt_in_normal_status()
{
    ...
    if(v<vth)
    {
        ...
        osstream<<"HVRT status of "<<get_compound_device_name()<<" is changed from "
