#include "header/model/wtg_models/wt_electrical_model/WT3EV.h"
...
WT3EV::WT3EV(STEPS& toolkit) : WT_ELECTRICAL_MODEL(toolkit),
...
{
    set_model_as_under_development();
    clear();
}

WT3EV::WT3EV(const WT3EV& model) : WT_ELECTRICAL_MODEL(model.get_toolkit()),
...
WT3EV& WT3EV::operator=(const WT3EV& model)
{
...
void WT3EV::copy_from_const_model(const WT3EV& model)
{
...
string WT3EV::get_model_name() const
{
    return "WT3EV";
}

void WT3EV::set_Xcomp_in_pu(double Xc)
{
    Xcomp = Xc;
}

void WT3EV::set_TRV_in_s(double T)
{
    voltage_sensor.set_T_in_s(T);
}

void WT3EV::set_Fn(double Fn)
{
    this->Fn = Fn;
}

void WT3EV::set_KIV(double K)
{
    if(K!=0.0)
        voltage_regulator_integrator.set_T_in_s(1.0/K);
}

void WT3EV::set_Qmax_in_pu(double q)
{
    voltage_regulator_integrator.set_upper_limit(q);
}

void WT3EV::set_Qmin_in_pu(double q)
{
    voltage_regulator_integrator.set_lower_limit(q);
}

void WT3EV::set_KPV(double K)
{
    voltage_regulator_first_order_block.set_K(K);
}

void WT3EV::set_TV_in_s(double T)
{
    voltage_regulator_first_order_block.set_T_in_s(T);
}

void WT3EV::set_TFV_in_s(double T)
{
    voltage_regulator_filter.set_T_in_s(T);
}

void WT3EV::set_TP_in_s(double T)
{
    active_power_sensor.set_T_in_s(T);
}

void WT3EV::set_KQI(double K)
{
    if(K!=0.0)
        Q_error_integrator.set_T_in_s(1.0/K);
}

void WT3EV::set_Vmax_in_pu(double v)
{
    Q_error_integrator.set_upper_limit(v);
}

void WT3EV::set_Vmin_in_pu(double v)
{
    Q_error_integrator.set_lower_limit(v);
}

void WT3EV::set_voltage_flag(unsigned int flag)
{
    if(flag<3)
        Voltage_Flag = flag;
    else
...
void WT3EV::set_KQV(double K)
{
    if(K!=0.0)
        V_error_integrator.set_T_in_s(1.0/K);
}

void WT3EV::set_EQmax_in_pu(double I)
{
    EQmax = I;
}

void WT3EV::set_EQmin_in_pu(double I)
{
    EQmin = I;
}

void WT3EV::set_Tspeed_in_s(double T)
{
    wind_turbine_speed_reference_sensor.set_T_in_s(T);
}

void WT3EV::set_KPP(double K)
{
    torque_PI_regulator.set_Kp(K);
}

void WT3EV::set_KIP(double K)
{
    torque_PI_regulator.set_Ki(K);
}

void WT3EV::set_Kvi(double K)
{
    virtual_inertia_emulator.set_K(K);
}

void WT3EV::set_Tvi_in_s(double T)
{
    virtual_inertia_emulator.set_T_in_s(T);
}

void WT3EV::set_Kdroop(double K)
{
    frequency_droop_controller.set_K(K);
}

void WT3EV::set_Tdroop_in_s(double T)
{
    frequency_droop_controller.set_T_in_s(T);
}

void WT3EV::set_frequency_deviation_upper_deadband_in_pu(double f)
{
    f_upper_pu = f;
}

void WT3EV::set_frequency_deviation_lower_deadband_in_pu(double f)
{
    f_lower_pu = f;
}

void WT3EV::set_Kfint(double K)
{
    double t = 0.0;
...
void WT3EV::set_rPmax_in_pu(double r)
{
    max_torque_rate = r;
}

void WT3EV::set_rPmin_in_pu(double r)
{
    min_torque_rate = r;
}

void WT3EV::set_TFP_in_s(double T)
{
    power_order_integrator.set_T_in_s(T);
}

void WT3EV::set_Pmax_in_pu(double p)
{
    power_order_integrator.set_upper_limit(p);
}

void WT3EV::set_Pmin_in_pu(double p)
{
    power_order_integrator.set_lower_limit(p);
}

void WT3EV::set_IPmax_in_pu(double I)
{
    IPmax = I;
}

double WT3EV::get_Xcomp_in_pu() const
{
    return Xcomp;
}

double WT3EV::get_TRV_in_s() const
{
    return voltage_sensor.get_T_in_s();
}

double WT3EV::get_Fn() const
{
    return Fn;
}

double WT3EV::get_KIV() const
{
    return 1.0/voltage_regulator_integrator.get_T_in_s();
}

double WT3EV::get_Qmax_in_pu() const
{
    return voltage_regulator_integrator.get_upper_limit();
}

double WT3EV::get_Qmin_in_pu() const
{
    return voltage_regulator_integrator.get_lower_limit();
}

double WT3EV::get_KPV() const
{
    return voltage_regulator_first_order_block.get_K();
}

double WT3EV::get_TV_in_s() const
{
    return voltage_regulator_first_order_block.get_T_in_s();
}

double WT3EV::get_TFV_in_s() const
{
    return voltage_regulator_filter.get_T_in_s();
}

double WT3EV::get_TP_in_s() const
{
    return active_power_sensor.get_T_in_s();
}

double WT3EV::get_KQI() const
{
    return 1.0/Q_error_integrator.get_T_in_s();
}

double WT3EV::get_Vmax_in_pu() const
{
    return Q_error_integrator.get_upper_limit();
}

double WT3EV::get_Vmin_in_pu() const
{
    return Q_error_integrator.get_lower_limit();
}

unsigned int WT3EV::get_voltage_flag() const
{
    return Voltage_Flag;
}

double WT3EV::get_KQV() const
{
    return 1.0/V_error_integrator.get_T_in_s();
}

double WT3EV::get_EQmax_in_pu() const
{
    return EQmax;
}

double WT3EV::get_EQmin_in_pu() const
{
    return EQmin;
}

double WT3EV::get_Tspeed_in_s() const
{
    return wind_turbine_speed_reference_sensor.get_T_in_s();
}

double WT3EV::get_KPP() const
{
    return torque_PI_regulator.get_Kp();
}

double WT3EV::get_KIP() const
{
    return torque_PI_regulator.get_Ki();
}

double WT3EV::get_Kvi() const
{
    return virtual_inertia_emulator.get_K();
}

double WT3EV::get_Tvi_in_s() const
{
    return virtual_inertia_emulator.get_T_in_s();
}

double WT3EV::get_Kdroop() const
{
    return frequency_droop_controller.get_K();
}

double WT3EV::get_Tdroop_in_s() const
{
    return frequency_droop_controller.get_T_in_s();
}

double WT3EV::get_frequency_deviation_upper_deadband_in_pu() const
{
    return f_upper_pu;
}

double WT3EV::get_frequency_deviation_lower_deadband_in_pu() const
{
    return f_lower_pu;
}

double WT3EV::get_Kfint() const
{
...
double WT3EV::get_rPmax_in_pu() const
{
    return max_torque_rate;
}

double WT3EV::get_rPmin_in_pu() const
{
    return min_torque_rate;
}

double WT3EV::get_TFP_in_s() const
{
    return power_order_integrator.get_T_in_s();
}

double WT3EV::get_Pmax_in_pu() const
{
    return power_order_integrator.get_upper_limit();
}

double WT3EV::get_Pmin_in_pu() const
{
    return power_order_integrator.get_lower_limit();
}

double WT3EV::get_IPmax_in_pu() const
{
    return IPmax;
}

bool WT3EV::is_frequency_regulation_enabled() const
{
    return frequency_regulation_enabled;
}
void WT3EV::trip_frequency_regulation()
{
    if(frequency_regulation_enabled==true)
        frequency_regulation_enabled = false;
}

void WT3EV::set_speed_reference_bias_in_pu(double bias)
{
    speedref_bias =  bias;
}

double WT3EV::get_speed_reference_bias_in_pu() const
{
    return speedref_bias;
}

bool WT3EV::setup_model_with_steps_string_vector(vector<string>& data)
{
...
bool WT3EV::setup_model_with_psse_string(string data)
{
    vector<string> record = psse_dyr_string2steps_string_vector(data);
    return setup_model_with_steps_string_vector(record);
}

bool WT3EV::setup_model_with_bpa_string(string data)
{
    ostringstream osstream;
...
void WT3EV::setup_block_toolkit_and_parameters()
{
}

void WT3EV::initialize()
{
    ostringstream osstream;
...
void WT3EV::run(DYNAMIC_MODE mode)
{
    double vterm = get_terminal_bus_voltage_in_pu();
    double iterm = get_wt_generator_terminal_current_in_pu();
...
/*    if(mode==UPDATE_MODE and is_frequency_regulation_enabled())
    ...
    //osstream<<"At time "<<toolkit.get_dynamic_simulation_time_in_s()<<", WT3EV power_order_integrator input is "<<input;
    //show_information_with_leading_time_stamp(osstream);
...
double WT3EV::get_active_current_command_in_pu_based_on_mbase()
{
    double vterm = get_terminal_bus_voltage_in_pu();
    if(vterm==0.0)
        return 0.0;
...
double WT3EV::get_active_power_command_in_pu_based_on_mbase() const
{
    return power_order_integrator.get_output();
}

double WT3EV::get_reactive_current_command_in_pu_based_on_mbase()
{
    return 0.0;
...
double WT3EV::get_reactive_power_command_in_pu_based_on_mbase()
{
...
double WT3EV::get_reactive_voltage_command_in_pu() const
{
...
string WT3EV::get_standard_psse_string(bool export_internal_bus_number) const
{
    ostringstream osstream;
...
void WT3EV::prepare_model_data_table()
{
...
double WT3EV::get_model_data_with_name(string par_name) const
{
...
void WT3EV::set_model_data_with_name(string par_name, double value)
{
    par_name = string2upper(par_name);
...
double WT3EV::get_minimum_nonzero_time_constant_in_s()
{
...
void WT3EV::prepare_model_internal_variable_table()
{
...
double WT3EV::get_model_internal_variable_with_name(string var_name)
{
...
string WT3EV::get_dynamic_data_in_psse_format() const
{
    return get_standard_psse_string();
}

string WT3EV::get_dynamic_data_in_bpa_format() const
{
    return get_dynamic_data_in_psse_format();
}

string WT3EV::get_dynamic_data_in_steps_format() const
{
    return get_dynamic_data_in_psse_format();
}
