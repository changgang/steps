...
void GAST2A::set_gas_Z(unsigned int Z)
{
    gas_governor_Z = Z;
}
...
unsigned int GAST2A::get_gas_Z() const
{
...
STEPS_SPARSE_MATRIX GAST2A::get_linearized_system_A() const
{
    STEPS_SPARSE_MATRIX A;

    return A;
}
STEPS_SPARSE_MATRIX GAST2A::get_linearized_system_B() const
{
...
STEPS_SPARSE_MATRIX GAST2A::get_linearized_system_C() const
{
...
STEPS_SPARSE_MATRIX GAST2A::get_linearized_system_D() const
{
...
void GAST2A::get_linearized_system_ABCD(STEPS_SPARSE_MATRIX* A, STEPS_SPARSE_MATRIX* B, STEPS_SPARSE_MATRIX* C, STEPS_SPARSE_MATRIX* D) const
{
    return;
}
