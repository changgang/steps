...
STEPS_SPARSE_MATRIX IEEEG1::get_linearized_system_A() const
{
    STEPS_SPARSE_MATRIX A;

    return A;
}
STEPS_SPARSE_MATRIX IEEEG1::get_linearized_system_B() const
{
...
STEPS_SPARSE_MATRIX IEEEG1::get_linearized_system_C() const
{
...
STEPS_SPARSE_MATRIX IEEEG1::get_linearized_system_D() const
{
...
void IEEEG1::get_linearized_system_ABCD(STEPS_SPARSE_MATRIX* A, STEPS_SPARSE_MATRIX* B, STEPS_SPARSE_MATRIX* C, STEPS_SPARSE_MATRIX* D) const
{
    return;
}
