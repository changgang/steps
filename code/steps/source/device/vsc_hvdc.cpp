...
bool VSC_HVDC::is_converter_a_dynamic_voltage_source(unsigned int index) const
{
...
complex<double> VSC_HVDC::get_converter_dynamic_current_to_ac_bus_in_pu_on_system_base_as_current_source(unsigned int converter_index)
{
    if(get_status() == true)
    {
        VSC_HVDC_CONVERTER_MODEL* model = get_vsc_hvdc_converter_model(converter_index);
...
complex<double> VSC_HVDC::get_converter_dynamic_Norton_current_to_ac_bus_in_pu_on_system_base_as_voltage_source(unsigned int converter_index)
{
    if(get_status() == true)
    {
        VSC_HVDC_CONVERTER_MODEL* model = get_vsc_hvdc_converter_model(converter_index);
