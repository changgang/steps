...
CONTINGENCY_SCREENER_TEST::CONTINGENCY_SCREENER_TEST()
{
    ...
    TEST_ADD(CONTINGENCY_SCREENER_TEST::test_set_get_flag_trip_line_after_clearing_fault);
...
void CONTINGENCY_SCREENER_TEST::test_set_get_flag_trip_line_after_clearing_fault()
{
    show_test_information_for_function_of_class(__FUNCTION__,"CONTINGENCY_SCREENER_TEST");
