...
COMPLEX_SPARSE_MATRIX_TEST::COMPLEX_SPARSE_MATRIX_TEST()
{
    TEST_ADD(COMPLEX_SPARSE_MATRIX_TEST::test_constructor);
    TEST_ADD(COMPLEX_SPARSE_MATRIX_TEST::test_add_entry);
    TEST_ADD(COMPLEX_SPARSE_MATRIX_TEST::test_set_get_matrix);
    TEST_ADD(COMPLEX_SPARSE_MATRIX_TEST::test_matrix_format);
    TEST_ADD(COMPLEX_SPARSE_MATRIX_TEST::test_get_matrix_size);
    TEST_ADD(COMPLEX_SPARSE_MATRIX_TEST::test_get_matrix_entry_count);
    TEST_ADD(COMPLEX_SPARSE_MATRIX_TEST::test_make_compressed_matrix);
    TEST_ADD(COMPLEX_SPARSE_MATRIX_TEST::test_transpose);
    TEST_ADD(COMPLEX_SPARSE_MATRIX_TEST::test_get_starting_index_of_column);
    TEST_ADD(COMPLEX_SPARSE_MATRIX_TEST::test_get_row_column_number_of_index);
    TEST_ADD(COMPLEX_SPARSE_MATRIX_TEST::test_get_entry_index);
    TEST_ADD(COMPLEX_SPARSE_MATRIX_TEST::test_get_entry_value_with_row_column);
    TEST_ADD(COMPLEX_SPARSE_MATRIX_TEST::test_get_entry_value_with_index);
    TEST_ADD(COMPLEX_SPARSE_MATRIX_TEST::test_change_entry_value);
    TEST_ADD(COMPLEX_SPARSE_MATRIX_TEST::test_clear);
    TEST_ADD(COMPLEX_SPARSE_MATRIX_TEST::test_get_reorder_permutation);
    TEST_ADD(COMPLEX_SPARSE_MATRIX_TEST::test_slove_Ax_equal_b);
    TEST_ADD(COMPLEX_SPARSE_MATRIX_TEST::test_solve_Ax_equal_b_with_operator_slash);

    TEST_ADD(COMPLEX_SPARSE_MATRIX_TEST::test_copy_with_operator_equal);
    TEST_ADD(COMPLEX_SPARSE_MATRIX_TEST::test_copy_with_copy_constructor);

    TEST_ADD(COMPLEX_SPARSE_MATRIX_TEST::test_save_matrix_to_file);
}

void COMPLEX_SPARSE_MATRIX_TEST::setup()
{
    ;
}

void COMPLEX_SPARSE_MATRIX_TEST::tear_down()
{
    matrix.clear();
    show_test_end_information();
}

void COMPLEX_SPARSE_MATRIX_TEST::prepare_basic_matrix()
{
    // matrix is
    // [1  0  0]      [0  0  0]
    // [0  2  4]  + j [0  5  9]
...
void COMPLEX_SPARSE_MATRIX_TEST::test_constructor()
{
    show_test_information_for_function_of_class(__FUNCTION__,"COMPLEX_SPARSE_MATRIX_TEST");

    TEST_ASSERT(matrix.get_matrix_size()==1);
}

void COMPLEX_SPARSE_MATRIX_TEST::test_add_entry()
{
    show_test_information_for_function_of_class(__FUNCTION__,"COMPLEX_SPARSE_MATRIX_TEST");

    STEPS_COMPLEX_SPARSE_MATRIX mat;
    mat.add_entry(0,0,1);
...
void COMPLEX_SPARSE_MATRIX_TEST::test_set_get_matrix()
{
    show_test_information_for_function_of_class(__FUNCTION__,"COMPLEX_SPARSE_MATRIX_TEST");
...
void COMPLEX_SPARSE_MATRIX_TEST::test_matrix_format()
{
    show_test_information_for_function_of_class(__FUNCTION__,"COMPLEX_SPARSE_MATRIX_TEST");
...
void COMPLEX_SPARSE_MATRIX_TEST::test_get_matrix_size()
{
    show_test_information_for_function_of_class(__FUNCTION__,"COMPLEX_SPARSE_MATRIX_TEST");
...
void COMPLEX_SPARSE_MATRIX_TEST::test_get_matrix_entry_count()
{
    show_test_information_for_function_of_class(__FUNCTION__,"COMPLEX_SPARSE_MATRIX_TEST");
...
void COMPLEX_SPARSE_MATRIX_TEST::test_make_compressed_matrix()
{
    show_test_information_for_function_of_class(__FUNCTION__,"COMPLEX_SPARSE_MATRIX_TEST");
...
void COMPLEX_SPARSE_MATRIX_TEST::test_transpose()
{
    show_test_information_for_function_of_class(__FUNCTION__,"COMPLEX_SPARSE_MATRIX_TEST");
...
void COMPLEX_SPARSE_MATRIX_TEST::test_get_starting_index_of_column()
{
    show_test_information_for_function_of_class(__FUNCTION__,"COMPLEX_SPARSE_MATRIX_TEST");
...
void COMPLEX_SPARSE_MATRIX_TEST::test_get_row_column_number_of_index()
{
    show_test_information_for_function_of_class(__FUNCTION__,"COMPLEX_SPARSE_MATRIX_TEST");
...
void COMPLEX_SPARSE_MATRIX_TEST::test_get_entry_index()
{
    show_test_information_for_function_of_class(__FUNCTION__,"COMPLEX_SPARSE_MATRIX_TEST");
...
void COMPLEX_SPARSE_MATRIX_TEST::test_get_entry_value_with_row_column()
{
    show_test_information_for_function_of_class(__FUNCTION__,"COMPLEX_SPARSE_MATRIX_TEST");
...
void COMPLEX_SPARSE_MATRIX_TEST::test_get_entry_value_with_index()
{
    show_test_information_for_function_of_class(__FUNCTION__,"COMPLEX_SPARSE_MATRIX_TEST");
...
void COMPLEX_SPARSE_MATRIX_TEST::test_change_entry_value()
{
    show_test_information_for_function_of_class(__FUNCTION__,"COMPLEX_SPARSE_MATRIX_TEST");
...
void COMPLEX_SPARSE_MATRIX_TEST::test_clear()
{
    show_test_information_for_function_of_class(__FUNCTION__,"COMPLEX_SPARSE_MATRIX_TEST");
...
void COMPLEX_SPARSE_MATRIX_TEST::test_get_reorder_permutation()
{
    show_test_information_for_function_of_class(__FUNCTION__,"COMPLEX_SPARSE_MATRIX_TEST");
...
void COMPLEX_SPARSE_MATRIX_TEST::test_slove_Ax_equal_b()
{
    show_test_information_for_function_of_class(__FUNCTION__,"COMPLEX_SPARSE_MATRIX_TEST");
...
void COMPLEX_SPARSE_MATRIX_TEST::test_copy_with_operator_equal()
{
    ...
    STEPS_COMPLEX_SPARSE_MATRIX newmatrix;
...
void COMPLEX_SPARSE_MATRIX_TEST::test_copy_with_copy_constructor()
{
    show_test_information_for_function_of_class(__FUNCTION__,"COMPLEX_SPARSE_MATRIX_TEST");
    ...
    STEPS_COMPLEX_SPARSE_MATRIX newmatrix = matrix; //here, copy constructor is called
...
void COMPLEX_SPARSE_MATRIX_TEST::test_save_matrix_to_file()
{
    show_test_information_for_function_of_class(__FUNCTION__,"COMPLEX_SPARSE_MATRIX_TEST");
