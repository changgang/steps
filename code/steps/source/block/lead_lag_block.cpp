...
double LEAD_LAG_BLOCK::get_linearized_system_variable(char var) const
{
    var = toupper(var);
    switch(var)
    {
...
double LEAD_LAG_BLOCK::get_linearized_system_A() const
{
    return 0.0;
}

double LEAD_LAG_BLOCK::get_linearized_system_B() const
{
    return 0.0;
}

double LEAD_LAG_BLOCK::get_linearized_system_C() const
{
    return 0.0;
}

double LEAD_LAG_BLOCK::get_linearized_system_D() const
{
    return 0.0;
}

double LEAD_LAG_BLOCK::get_linearized_system_E() const
{
    return 0.0;
}

double LEAD_LAG_BLOCK::get_linearized_system_F() const
{
    return 0.0;
}

double LEAD_LAG_BLOCK::get_linearized_system_G() const
{
    return 0.0;
}

double LEAD_LAG_BLOCK::get_linearized_system_H() const
{
    return 0.0;
}
