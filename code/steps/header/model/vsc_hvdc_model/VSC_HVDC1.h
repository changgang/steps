...
class VSC_HVDC1: public VSC_HVDC_MODEL
{
    ...
    public: // specific exciter
        ...
        unsigned int get_converter_bus(unsigned int index);
        unsigned int get_converter_active_control_mode(unsigned int index);
        unsigned int get_converter_reactive_control_mode(unsigned int index);
        double get_converter_active_power_control_T_in_s(unsigned int index);
        double get_converter_active_power_Pmax_in_pu(unsigned int index);
        double get_converter_active_power_Pmin_in_pu(unsigned int index);
        double get_converter_active_power_kpp(unsigned int index);
        double get_converter_reactive_power_control_T_in_s(unsigned int index);
        double get_converter_reactive_power_Qmax_in_pu(unsigned int index);
        double get_converter_reactive_power_Qmin_in_pu(unsigned int index);
        double get_converter_reactive_power_kpq(unsigned int index);
        double get_converter_dc_voltage_control_T_in_s(unsigned int index);
        double get_converter_dc_voltage_Umax(unsigned int index);
        double get_converter_dc_voltage_Umin(unsigned int index);
        double get_converter_dc_voltage_kpud(unsigned int index);
        double get_converter_ac_voltage_control_T_in_s(unsigned int index);
        double get_converter_ac_voltage_Umax(unsigned int index);
        double get_converter_ac_voltage_Umin(unsigned int index);
        double get_converter_dc_voltage_kpuc(unsigned int index);
        double get_dc_voltage_ceq(unsigned int index);
    ...
    public:
        ...
        string get_standard_psse_string() const;
        ...
        double get_model_internal_variable_with_name(string var_name);
