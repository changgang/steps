...
void PSASPS4::set_T8_in_s(double T)
{
...
void PSASPS4::set_Vssmax(double vmax)
{
    Vssmax = vmax;
}
void PSASPS4::set_Vssmin(double vmin)
{
    Vssmin = vmin;
}

void PSASPS4::set_Vcmax(double vmax)
{
    Vcmax = vmax;
}

void PSASPS4::set_Vcmin(double vmin)
{
    Vcmin = vmin;
}


double PSASPS4::get_K1() const
{
...
double PSASPS4::get_T8_in_s() const
{
...
double PSASPS4::get_Vssmax() const
{
    return Vssmax;
}
double PSASPS4::get_Vssmin() const
{
    return Vssmin;
}
double PSASPS4::get_Vcmax() const
{
    return Vcmax;
}
double PSASPS4::get_Vcmin() const
{
    return Vcmin;
}
