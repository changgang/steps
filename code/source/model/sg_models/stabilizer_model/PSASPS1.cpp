...
PSASPS1::PSASPS1(const PSASPS1& model) : STABILIZER_MODEL()
{
...
void PSASPS1::set_K1(double K)
{
    sensor_1.set_K(K);
}

void PSASPS1::set_T1_in_s(double T)
{
    sensor_1.set_T_in_s(T);
}

void PSASPS1::set_K2(double K)
{
    sensor_2.set_K(K);
}

void PSASPS1::set_T2_in_s(double T)
{
    sensor_2.set_T_in_s(T);
}

void PSASPS1::set_T3_in_s(double T)
{
    filter.set_K(T);
    if(T<=0.0)
...
void PSASPS1::set_T4_in_s(double T)
{
    filter.set_T_in_s(T);
    alternative_filter.set_T_in_s(T);
}

void PSASPS1::set_T5_in_s(double T)
{
    phase_tuner_1.set_T1_in_s(T);
}

void PSASPS1::set_T6_in_s(double T)
{
    phase_tuner_1.set_T2_in_s(T);
}

void PSASPS1::set_T7_in_s(double T)
{
    phase_tuner_2.set_T1_in_s(T);
}
void PSASPS1::set_T8_in_s(double T)
{
    phase_tuner_2.set_T2_in_s(T);
}
void PSASPS1::set_T9_in_s(double T)
{
    phase_tuner_3.set_T1_in_s(T);
}
void PSASPS1::set_T10_in_s(double T)
{
    phase_tuner_3.set_T2_in_s(T);
}
void PSASPS1::set_Vssmax(double vmax)
{
    Vssmax = vmax;
}
void PSASPS1::set_Vssmin(double vmin)
{
    Vssmin = vmin;
}

void PSASPS1::set_Vcmax(double vmax)
{
    Vcmax = vmax;
}

void PSASPS1::set_Vcmin(double vmin)
{
    Vcmin = vmin;
}


double PSASPS1::get_K1() const
{
    return sensor_1.get_K();
}

double PSASPS1::get_T1_in_s() const
{
    return sensor_1.get_T_in_s();
}

double PSASPS1::get_K2() const
{
    return sensor_2.get_K();
}

double PSASPS1::get_T2_in_s() const
{
    return sensor_2.get_T_in_s();
}

double PSASPS1::get_T3_in_s() const
{
    return filter.get_K();
}

double PSASPS1::get_T4_in_s() const
{
    return filter.get_T_in_s();
}
double PSASPS1::get_T5_in_s() const
{
    return phase_tuner_1.get_T1_in_s();
}
double PSASPS1::get_T6_in_s() const
{
    return phase_tuner_1.get_T2_in_s();
}
double PSASPS1::get_T7_in_s() const
{
    return phase_tuner_2.get_T1_in_s();
}
double PSASPS1::get_T8_in_s() const
{
    return phase_tuner_2.get_T2_in_s();
}
double PSASPS1::get_T9_in_s() const
{
    return phase_tuner_3.get_T1_in_s();
}
double PSASPS1::get_T10_in_s() const
{
    return phase_tuner_3.get_T2_in_s();
}

double PSASPS1::get_Vssmax() const
{
    return Vssmax;
}
double PSASPS1::get_Vssmin() const
{
    return Vssmin;
}
double PSASPS1::get_Vcmax() const
{
    return Vcmax;
}
double PSASPS1::get_Vcmin() const
{
    return Vcmin;
}
