...
void PSASPS2::set_T7_in_s(double T)
{
    phase_tuner_2.set_T1_in_s(T);
}
void PSASPS2::set_T8_in_s(double T)
{
    phase_tuner_2.set_T2_in_s(T);
}
void PSASPS2::set_T9_in_s(double T)
{
    phase_tuner_3.set_T1_in_s(T);
}
void PSASPS2::set_T10_in_s(double T)
{
    phase_tuner_3.set_T2_in_s(T);
}
void PSASPS2::set_Vssmax(double vmax)
{
    Vssmax = vmax;
}
void PSASPS2::set_Vssmin(double vmin)
{
    Vssmin = vmin;
}

void PSASPS2::set_Vcmax(double vmax)
{
    Vcmax = vmax;
}

void PSASPS2::set_Vcmin(double vmin)
{
    Vcmin = vmin;
}


double PSASPS2::get_K1() const
{
...
double PSASPS2::get_T7_in_s() const
{
    return phase_tuner_2.get_T1_in_s();
}
double PSASPS2::get_T8_in_s() const
{
    return phase_tuner_2.get_T2_in_s();
}
double PSASPS2::get_T9_in_s() const
{
    return phase_tuner_3.get_T1_in_s();
}
double PSASPS2::get_T10_in_s() const
{
    return phase_tuner_3.get_T2_in_s();
}

double PSASPS2::get_Vssmax() const
{
    return Vssmax;
}
double PSASPS2::get_Vssmin() const
{
    return Vssmin;
}
double PSASPS2::get_Vcmax() const
{
    return Vcmax;
}
double PSASPS2::get_Vcmin() const
{
    return Vcmin;
}
