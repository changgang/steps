...
void PSASPS3::set_T1_in_s(double T)
{
...
void PSASPS3::set_T2_in_s(double T)
{
    sensor_2.set_T_in_s(T);
}

void PSASPS3::set_T3_in_s(double T)
{
    filter.set_K(T);
    if(T<=0.0)
...
void PSASPS3::set_T4_in_s(double T)
{
    filter.set_T_in_s(T);
    alternative_filter.set_T_in_s(T);
}

void PSASPS3::set_T5_in_s(double T)
{
    phase_tuner_1.set_T1_in_s(T);
}

void PSASPS3::set_T6_in_s(double T)
{
    phase_tuner_1.set_T2_in_s(T);
}

void PSASPS3::set_T7_in_s(double T)
{
    phase_tuner_2.set_T1_in_s(T);
}
void PSASPS3::set_T8_in_s(double T)
{
    phase_tuner_2.set_T2_in_s(T);
}
void PSASPS3::set_T9_in_s(double T)
{
    phase_tuner_3.set_T1_in_s(T);
}
void PSASPS3::set_T10_in_s(double T)
{
    phase_tuner_3.set_T2_in_s(T);
}
void PSASPS3::set_Vssmax(double vmax)
{
    Vssmax = vmax;
}
void PSASPS3::set_Vssmin(double vmin)
{
    Vssmin = vmin;
}

void PSASPS3::set_Vcmax(double vmax)
{
    Vcmax = vmax;
}

void PSASPS3::set_Vcmin(double vmin)
{
    Vcmin = vmin;
}
...
double PSASPS3::get_T1_in_s() const
{
...
double PSASPS3::get_T2_in_s() const
{
    return sensor_2.get_T_in_s();
}

double PSASPS3::get_T3_in_s() const
{
    return filter.get_K();
}

double PSASPS3::get_T4_in_s() const
{
    return filter.get_T_in_s();
}
double PSASPS3::get_T5_in_s() const
{
    return phase_tuner_1.get_T1_in_s();
}
double PSASPS3::get_T6_in_s() const
{
    return phase_tuner_1.get_T2_in_s();
}
double PSASPS3::get_T7_in_s() const
{
    return phase_tuner_2.get_T1_in_s();
}
double PSASPS3::get_T8_in_s() const
{
    return phase_tuner_2.get_T2_in_s();
}
double PSASPS3::get_T9_in_s() const
{
    return phase_tuner_3.get_T1_in_s();
}
double PSASPS3::get_T10_in_s() const
{
    return phase_tuner_3.get_T2_in_s();
}

double PSASPS3::get_Vssmax() const
{
    return Vssmax;
}
double PSASPS3::get_Vssmin() const
{
    return Vssmin;
}
double PSASPS3::get_Vcmax() const
{
    return Vcmax;
}
double PSASPS3::get_Vcmin() const
{
    return Vcmin;
}
