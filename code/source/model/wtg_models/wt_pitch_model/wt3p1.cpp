#include "header/model/wtg_models/wt_pitch_model/wt3p1.h"
...
void WT3P1::copy_from_const_model(const WT3P1& model)
{
    clear();
...
WT3P1::WT3P1(const WT3P1&model) : WT_PITCH_MODEL()
{
    copy_from_const_model(model);
}

WT3P1& WT3P1::operator=(const WT3P1& model)
{
    if(this==&model)
        return *this;
...
string WT3P1::get_model_name() const
{
    return "WT3P1";
}

double WT3P1::get_double_data_with_index(size_t index) const
{
    return 0.0;
}

double WT3P1::get_double_data_with_name(string par_name) const
{
...
void WT3P1::set_double_data_with_index(size_t index, double value)
{
    if(index==0)
        return;
}

void WT3P1::set_double_data_with_name(string par_name, double value)
{
    par_name = string2upper(par_name);
    if(par_name=="PITCHMAX")
...
void WT3P1::set_Tp_in_s(double T)
{
    pitch_integrator.set_T_in_s(T);
}

void WT3P1::set_Kp_speed_controller(double K)
{
    speed_controller.set_Kp(K);
}

void WT3P1::set_Ki_speed_controller(double K)
{
    speed_controller.set_Ki(K);
}

void WT3P1::set_Kp_power_controller(double K)
{
    power_controller.set_Kp(K);
}

void WT3P1::set_Ki_power_controller(double K)
{
    power_controller.set_Ki(K);
}

void WT3P1::set_Pitchmax_in_deg(double P)
{
    pitch_integrator.set_upper_limit(P);
}

void WT3P1::set_Pitchmin_in_deg(double P)
{
    pitch_integrator.set_lower_limit(P);
}

void WT3P1::set_ratePitchmax_in_deg_per_s(double rP)
{
    ratePitchmax = rP;
}

double WT3P1::get_Tp_in_s() const
{
    return pitch_integrator.get_T_in_s();
}

double WT3P1::get_Kp_speed_controller() const
{
    return speed_controller.get_Kp();
}

double WT3P1::get_Ki_speed_controller() const
{
    return speed_controller.get_Ki();
}

double WT3P1::get_Kp_power_controller() const
{
    return power_controller.get_Kp();
}

double WT3P1::get_Ki_power_controller() const
{
    return power_controller.get_Ki();
}

double WT3P1::get_Pitchmax_in_deg() const
{
    return pitch_integrator.get_upper_limit();
}

double WT3P1::get_Pitchmin_in_deg() const
{
    return pitch_integrator.get_lower_limit();
}

double WT3P1::get_ratePitchmax_in_deg_per_s() const
{
    return ratePitchmax;
}


bool WT3P1::setup_model_with_steps_string(string data)
{
    return false;
}

bool WT3P1::setup_model_with_psse_string(string data)
{
    ...
    double tp, kps, kis, kpp, kip, pmax, pmin, rpmax, pref;
...
bool WT3P1::setup_model_with_bpa_string(string data)
{
    return false;
}
...
void WT3P1::run(DYNAMIC_MODE mode)
{
    double speed = get_wt_generator_speed_in_pu();
    ...
    double rate = speed_controller.get_output()+power_controller.get_output();
...
double WT3P1::get_pitch_angle_in_deg() const
{
...
string WT3P1::get_dynamic_data_in_psse_format() const
{
    return "";
}

string WT3P1::get_dynamic_data_in_bpa_format() const
{
    return get_dynamic_data_in_psse_format();
}

string WT3P1::get_dynamic_data_in_steps_format() const
{
    return get_dynamic_data_in_psse_format();
}
