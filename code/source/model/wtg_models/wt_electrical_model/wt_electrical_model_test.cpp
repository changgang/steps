...
WT_ELECTRICAL_MODEL_TEST::WT_ELECTRICAL_MODEL_TEST()
{
    ...
    TEST_ADD(WT_ELECTRICAL_MODEL_TEST::test_get_compensated_voltage);
...
GENERATOR* WT_ELECTRICAL_MODEL_TEST::get_generator()
{
    return genptr;
}
...
void WT_ELECTRICAL_MODEL_TEST::test_get_model_type()
{
    ...
    WT_ELECTRICAL_MODEL* model = genptr->get_exciter_model();
...
void WT_ELECTRICAL_MODEL_TEST::test_get_compensated_voltage()
{
    GENERATOR* genptr = get_generator();
    WT_ELECTRICAL_MODEL* model = genptr->get_exciter_model();
    show_test_information_for_function_of_class(__FUNCTION__,model->get_model_name()+"_TEST");
