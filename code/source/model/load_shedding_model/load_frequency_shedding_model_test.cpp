...
using namespace std;
LOAD_FREQUENCY_SHEDDING_MODEL_TEST::LOAD_FREQUENCY_SHEDDING_MODEL_TEST() : LOAD_SHEDDING_MODEL_TEST()
{
    TEST_ADD(LOAD_FREQUENCY_SHEDDING_MODEL_TEST::test_model_type);
    TEST_ADD(LOAD_FREQUENCY_SHEDDING_MODEL_TEST::test_get_bus_frequency);
    TEST_ADD(LOAD_FREQUENCY_SHEDDING_MODEL_TEST::test_run);
}



void LOAD_FREQUENCY_SHEDDING_MODEL_TEST::setup()
{
    LOAD_SHEDDING_MODEL_TEST::setup();
}

void LOAD_FREQUENCY_SHEDDING_MODEL_TEST::tear_down()
{
    LOAD_SHEDDING_MODEL_TEST::tear_down();
}

void LOAD_FREQUENCY_SHEDDING_MODEL_TEST::test_model_type()
{
    LOAD* load = get_load();
    ...
    TEST_ASSERT(model->get_model_type()=="LOAD FREQUENCY SHEDDING");
}

void LOAD_FREQUENCY_SHEDDING_MODEL_TEST::test_get_bus_frequency()
{
    LOAD* load = get_load();
    LOAD_FREQUENCY_SHEDDING_MODEL* model = load->get_load_frequency_shedding_model();
...
void LOAD_FREQUENCY_SHEDDING_MODEL_TEST::export_meter_title()
{
...
void LOAD_FREQUENCY_SHEDDING_MODEL_TEST::export_meter_values()
{
    LOAD* load = get_load();
    LOAD_FREQUENCY_SHEDDING_MODEL* model = load->get_load_frequency_shedding_model();
...
void LOAD_FREQUENCY_SHEDDING_MODEL_TEST::test_run()
{
    LOAD* load = get_load();
    LOAD_FREQUENCY_SHEDDING_MODEL* model = load->get_load_frequency_shedding_model();
...
void LOAD_FREQUENCY_SHEDDING_MODEL_TEST::run_model(string outputfile)
{
    LOAD* load = get_load();
    LOAD_FREQUENCY_SHEDDING_MODEL* model = load->get_load_frequency_shedding_model();
