...
NETWORK_MATRIX* JACOBIAN_BUILDER::get_network_matrix() const
{
...
{
    ostringstream osstream;
    osstream<<__LINE__<<" of "<<__FUNCTION__<<" in "<<__FILE__;
...
STEPS_SPARSE_MATRIX JACOBIAN_BUILDER::get_decoupled_B_jacobian_with_Q_equation_internal_buses(const vector<size_t> internal_Q_equation_buses)
{
    ...
    osstream<<"Building BQ matrix for reactive power solution.";
    toolkit.show_information_with_leading_time_stamp(osstream);
    ...
    osstream<<"Done building BQ matrix for reactive power solution.";
    toolkit.show_information_with_leading_time_stamp(osstream);
