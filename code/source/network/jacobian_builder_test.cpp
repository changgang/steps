...
void JACOBIAN_BUILDER_TEST::test_form_and_show_seprate_jacobians()
{
    ...
    sstream<<"Jacobian with initial voltage from Arthur R. Arthur_R_Bergen";
...
void JACOBIAN_BUILDER_TEST::test_update_seprate_jacobians()
{
    ...
    sstream<<"Jacobian with voltage of the first iteration from Arthur R. Arthur_R_Bergen";
    show_information_with_leading_time_stamp(sstream);
...
void JACOBIAN_BUILDER_TEST::test_get_full_jacobian_for_coupled_P_and_Q_equations()
{
    ...
    sstream<<"Full Jacobian with initial voltage from Arthur R. Arthur_R_Bergen";
    show_information_with_leading_time_stamp(sstream);
    ...
    sstream<<"Full Jacobian with voltage of the first iteration from Arthur R. Arthur_R_Bergen";
    show_information_with_leading_time_stamp(sstream);
...
void JACOBIAN_BUILDER_TEST::test_get_decoupled_B_jacobian_for_P_equations()
{
    ...
    sstream<<"Decoupled B Jacobian for P equations from Arthur R. Arthur_R_Bergen";
    show_information_with_leading_time_stamp(sstream);
...
void JACOBIAN_BUILDER_TEST::test_get_decoupled_B_jacobian_for_Q_equations()
{
    ...
    sstream<<"Decoupled B Jacobian for Q equations from Arthur R. Arthur_R_Bergen";
    show_information_with_leading_time_stamp(sstream);
