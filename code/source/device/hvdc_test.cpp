...
void HVDC_TEST::test_set_get_converter_transformer_base_voltage()
{
    ...
    hvdc->set_converter_transformer_grid_side_base_voltage_in_kV(RECTIFIER, -500.0);
    TEST_ASSERT(hvdc->get_converter_transformer_grid_side_base_voltage_in_kV(RECTIFIER)==db->get_bus_base_voltage_in_kV(rec_bus));
    ...
    hvdc->set_converter_transformer_grid_side_base_voltage_in_kV(INVERTER, -500.0);
    TEST_ASSERT(hvdc->get_converter_transformer_grid_side_base_voltage_in_kV(INVERTER)==db->get_bus_base_voltage_in_kV(inv_bus));
