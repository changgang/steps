...
void ENERGY_STORAGE_TEST::setup()
{
    ...
    energy_storage = new ENERGY_STORAGE(db);
}
...
void ENERGY_STORAGE_TEST::test_constructor()
{
    ...
    TEST_ASSERT(energy_storage->get_mbase_in_MVA()==db->get_system_base_power_in_MVA());
...
void ENERGY_STORAGE_TEST::test_set_get_energy_storage_model()
{
    ...
    ENERGY_STORAGE* estorage = db->get_energy_storage(did);
