...
for gen in gens:
    ...
    pmax = simulator.get_generator_related_model_data(gen, "gov", 'd', 'pmax')
    pmin = simulator.get_generator_related_model_data(gen, "gov", 'd', 'pmin')
...
simulator.load_dynamic_data('ieee39_genrou.dyr','psse')

simulator.set_dynamic_simulator_parameter('i', 'max_DAE_iter', 200)
simulator.set_dynamic_simulator_parameter('i', 'max_NET_iter', 200)
simulator.set_dynamic_simulation_time_step(0.001)
simulator.set_dynamic_simulator_output_file('ieee39_pysteps')
