...
class STEPS():
    ...
    def get_toolkit_string_data(self, dataname):
        global STEPS_LIB
        dataname = self.__get_c_char_p_of_string(dataname)
        return STEPS_LIB.api_get_toolkit_string_data(dataname, self.toolkit_index)        
    ...
    def bus_number2name(self, bus):
        global STEPS_LIB
        return str(STEPS_LIB.api_bus_number2bus_name(bus, self.toolkit_index))
    ...
    def get_bus_data(self, bus, par_type, par_name):
        ...
        if par_type in ['S', 'STRING']:
            return str(STEPS_LIB.api_get_bus_string_data(bus, par_name, self.toolkit_index))
        return None
    ...
    def __get_source_data(self, source, par_type, par_name):
        ...
        if par_type in ['S', 'STRING']:
            return str(STEPS_LIB.api_get_source_string_data(bus, ickt, par_name, self.toolkit_index))
        return None
    ...
    def get_load_data(self, load, par_type, par_name):
        ...
        if par_type in ['S', 'STRING']:
            return str(STEPS_LIB.api_get_load_string_data(bus, ickt, par_name, self.toolkit_index))
        return None
    ...
    def get_fixed_shunt_data(self, fixed_shunt, par_type, par_name):
        ...
        if par_type in ['S', 'STRING']:
            return str(STEPS_LIB.api_get_fixed_shunt_string_data(bus, ickt, par_name, self.toolkit_index))
        return None
    ...
    def get_equivalent_device_data(self, equivalent_device, par_type, par_name):
        ...
        if par_type in ['S', 'STRING']:
            return str(STEPS_LIB.api_get_equivalent_device_string_data(bus, ickt, par_name, self.toolkit_index))
        return None
    ...
    def get_line_data(self, line, par_type, par_name):
        ...
        if par_type in ['S', 'STRING']:
            return str(STEPS_LIB.api_get_line_string_data(ibus, jbus, ickt, par_name, self.toolkit_index))
        return None
    ...
    def get_transformer_data(self, transformer, par_type, side, par_name):
        ...
        if par_type in ['S', 'STRING']:
            return str(STEPS_LIB.api_get_transformer_string_data(ibus, jbus, kbus, ickt, side, par_name, self.toolkit_index))
        return None
    ...
    def get_hvdc_data(self, hvdc, par_type, side, par_name):
        ...
        if par_type in ['S', 'STRING']:
            return str(STEPS_LIB.api_get_hvdc_string_data(ibus, jbus, ickt, side, par_name, self.toolkit_index))
        return None
    ...
    def get_area_data(self, area, par_type, par_name):
        ...
        if par_type in ['S', 'STRING']:
            return str(STEPS_LIB.api_get_area_string_data(area, par_name, self.toolkit_index))
        return None
    ...
    def get_zone_data(self, zone, par_type, par_name):
        ...
        if par_type in ['S', 'STRING']:
            return str(STEPS_LIB.api_get_zone_string_data(zone, par_name, self.toolkit_index))
        return None
    ...
    def get_owner_data(self, owner, par_type, par_name):
        ...
        if par_type in ['S', 'STRING']:
            return str(STEPS_LIB.api_get_owner_string_data(owner, par_name, self.toolkit_index))
        return None
    ...
    def get_generator_related_model_name(self, generator, model_type):
        ...
        return str(STEPS_LIB.api_get_generator_related_model_name(ibus, ickt, model_type, self.toolkit_index))
    ...
    def get_wt_generator_related_model_name(self, generator, model_type):
        ...
        ickt = self.__get_c_char_p_of_string(ickt)
        model_type = self.__get_c_char_p_of_string(model_type)
        return str(STEPS_LIB.api_get_wt_generator_related_model_name(ibus, ickt, model_type, self.toolkit_index))
    ...
    def get_pv_unit_related_model_name(self, pv_unit, model_type):
        ...
        ickt = self.__get_c_char_p_of_string(ickt)
        model_type = self.__get_c_char_p_of_string(model_type)
        return str(STEPS_LIB.api_get_pv_unit_related_model_name(ibus, ickt, model_type, self.toolkit_index))
    ...
    def get_dynamic_simulator_parameter(self, par_type, par_name):
        ...
        if par_type in ['S', 'STRING']:
            return str(STEPS_LIB.api_get_dynamic_simulator_string_parameter(par_name, self.toolkit_index))
        return None
    ...
    def get_dynamic_simulator_output_file(self):
        global STEPS_LIB
        return str(STEPS_LIB.api_get_dynamic_simulator_output_file(self.toolkit_index))
