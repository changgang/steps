...
libsteps.api_prepare_line_related_meters.argtypes = (c_uint, c_uint, c_char_p, c_char_p, c_uint)
...
libsteps.api_prepare_wt_generator_related_meter.argtypes = (c_uint, c_char_p, c_char_p)
