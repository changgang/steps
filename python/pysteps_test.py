...
pysteps.set_bus_fault(15, 'three phase fault',[0.0, -2e4])
pysteps.run_dynamic_simulation_to_time(1.1)
pysteps.clear_bus_fault(15, 'three phase fault')
pysteps.run_dynamic_simulation_to_time(5.0)
